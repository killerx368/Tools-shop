        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerPhoneNumber = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    BuyerName = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false),
                    BuyerAddress = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderdProducts_Products_ProductId",
